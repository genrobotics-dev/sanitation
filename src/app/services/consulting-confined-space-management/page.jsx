...
export function generateMetadata() {
  return createMetadata({
    ...
    url: "https://sanitation.genrobotics.com/services/consulting-confined-space-management",
    image:
      "https://images.prismic.io/gen-robotics/8acaddbf-43be-4848-9bcf-45d2a7de2b05_JKR_8841.webp?auto=compress,format",
    alternates: {
      canonical: "https://sanitation.genrobotics.com/services/consulting-confined-space-management",
    },
  });
}
